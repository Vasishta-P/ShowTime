...
public class GetPopularListAsync extends AsyncTask<String, String, String>{
    ...
    public GetPopularListAsync(Context context) {
        this.context = context;
    }

    @Override
    protected void onPreExecute() {
        now_playingurl = context.getString(R.string.popular_url);
    ...
    protected void onPostExecute(String result){
       ArrayList<MovieItemClass> movieList = parseMovieList(parseString);
        ...
        if(movieList == null || movieList.size() == 0){
            ...
            moivies_database.insertMovieList(movieList, 3);
        }
    }
