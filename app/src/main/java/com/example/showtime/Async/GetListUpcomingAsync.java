...
//This Async-task will get all movies that are listed as Upcoming from the movie DB
public class GetListUpcomingAsync extends AsyncTask<String, String, String>{
    ...
    public GetListUpcomingAsync(Context context) {
        this.context = context;
    }

    @Override
    protected void onPreExecute() {
        upcoming_url = context.getString(R.string.upcoming_url);
    ...
    protected void onPostExecute(String result){
       ArrayList<MovieItemClass> movieList = parseMovieList(parseString);
        ...
        if(movieList == null || movieList.size() == 0){
            ...
            moivies_database.insertMovieList(movieList, 1);
        }
    }
