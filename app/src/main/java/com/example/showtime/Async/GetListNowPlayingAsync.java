...
//This Async-task will get all movies that are listed as now playing from the movie DB
public class GetListNowPlayingAsync extends AsyncTask<String, String, String>{
    ...
    public GetListNowPlayingAsync(Context context) {
        this.context = context;
    }

    @Override
    protected void onPreExecute() {
        now_playingurl = context.getString(R.string.now_playing_url);
    ...
    protected void onPostExecute(String result){
       ...
       //If the list is null or count is zero then display error messagebox to the user
        if(movieList == null || movieList.size() == 0){
            ...
            moivies_database.insertMovieList(movieList, 0);
        }
    }
